...
function Authentification(props) {
  ...
  <div style={{ display: 'flex', justifyContent: 'center', marginTop: '80px', marginBottom: '40px' }}>
    <button onClick={handleSignIn} disabled={!isKeyValid} style={{ fontFamily: 'Euclid Circular A Light, sans-serif',borderRadius: '20px', color: 'white', width: '200px', height: '40px', border: 'none', backgroundColor: '#5CC2C2', marginRight: '40px', fontSize: '16px'}}>Sign In</button>
  </div>
</div>
